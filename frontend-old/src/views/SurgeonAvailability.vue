<template>
  <div class="surgeon-availability">
    <div class="flex justify-content-between align-items-center mb-4">
      <h1 class="text-3xl font-bold">Surgeon Availability</h1>
      <div>
    ...
    <AvailabilityCalendar 
      title="Surgeon Availability Calendar" 
      type="surgeon" 
...
export default {
  ...
  setup() {
    ...
    const loadAvailabilityData = async () => {
      ...
      // const response = await axios.get('/api/surgeons/availability');
    ...
    const saveChanges = async () => {
      try {
        // In a real application, this would be an API call
        // await axios.post('/api/surgeons/availability', availabilityData.value);
        ...
        toast.add({
          ...
          detail: 'Surgeon availability has been updated successfully',
          life: 3000
        });
      } catch (error) {
        toast.add({
